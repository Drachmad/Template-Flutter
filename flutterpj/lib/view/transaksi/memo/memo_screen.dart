...
import 'package:flutterpj/view/transaksi/memo/add_memo_screen.dart';
import 'package:flutterpj/view/transaksi/memo/memo_card.dart';
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      if (value != null) {
                        if (value) {
                          memoController.selectDataPaginate(
                              true, memoController.searchController.text);
                        }
                      }
                    });
                  },
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return MemoCard(index, pressEdit: () {
                            Navigator.push(
                              ...
                              if (value != null) {
                                if (value) {
                                  memoController.selectDataPaginate(true,
                                      memoController.searchController.text);
                                }
                              }
                            });
                          }, pressDelete: () {
        ...
        bottomNavigationBar: Container(
          ...
          child: Padding(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                if (memoController.data_memo_list.length > 0)
                  Text(
                    (memoController.offset + 1 < memoController.totalNotaTerima)
                        ? "Showing ${memoController.offset + 1} to ${memoController.offset + memoController.limit} of ${memoController.totalNotaTerima} entries"
                        : "Showing ${memoController.offset + 1} to ${memoController.totalNotaTerima} of ${memoController.totalNotaTerima} entries",
                    style: GoogleFonts.poppins(
                        fontSize: 14,
                        fontWeight: FontWeight.w400,
                        color: Colors.black),
                      ...
                      child: Padding(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            value: memoController.limit,
                            items: memoController.dropdownLimit,
                            onChanged: (value) {
                              if (value != null) {
                                memoController.limit = value;
                                memoController.selectDataPaginate(false,
                                    memoController.searchController.text);
                              }
                            },
                          ),
                ...
                InkWell(
                  onTap: () {
                    if (memoController.page_index > 0) {
                      memoController.offset -= memoController.limit;
                      memoController.page_index--;
                      memoController.c_page.text =
                          (memoController.page_index + 1).toString();
                      memoController.selectDataPaginate(
                          false, memoController.searchController.text);
                    }
                  },
                  child: Container(
                    height: 35,
                ...
                InkWell(
                  onTap: () {
                    if (memoController.page_index <=
                        memoController.pageCount - 1) {
                      memoController.offset += memoController.limit;
                      memoController.page_index++;
                      memoController.c_page.text =
                          (memoController.page_index + 1).toString();
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: GoogleFonts.poppins(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: ((memoController.pageCount -
                                        memoController.page_index) <=
                                    1)
                                ? GreyColor
                                : Colors.black),
