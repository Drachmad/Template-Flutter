...
import 'package:flutterpj/view/transaksi/kasmasuk/add_kasmasuk_screen.dart';
import 'package:flutterpj/view/transaksi/kasmasuk/kasmasuk_card.dart';
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      if (value != null) {
                        if (value) {
                          kasmasukController.selectDataPaginate(
                              true, kasmasukController.searchController.text);
                        }
                      }
                    });
                  },
        ...
        body: Container(
          ...
          child: Column(
            children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          showAnimatedDialog_withCallBack(
                            ...
                            if (value != null) {
                              if (value) {
                                kasmasukController.selectDataPaginate(true,
                                    kasmasukController.searchController.text);
              ...
              Expanded(
                child: (kasmasukController.data_kasmasuk_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount: kasmasukController.data_kasmasuk_list.length,
                        itemBuilder: (BuildContext context, int index) {
                          return KasMasukCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
        ...
        bottomNavigationBar: Container(
          ...
          child: Padding(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                if (kasmasukController.data_kasmasuk_list.length > 0)
                  Text(
                          ...
                          child: DropdownButton(
                            ...
                            onChanged: (value) {
                              if (value != null) {
                                ...
                                kasmasukController.selectDataPaginate(false,
                                    kasmasukController.searchController.text);
                              }
                            },
                          ),
                ...
                InkWell(
                  onTap: () {
                    if (kasmasukController.page_index > 0) {
                      ...
                      kasmasukController.selectDataPaginate(
                          false, kasmasukController.searchController.text);
                    }
                  },
                  child: Container(
                    height: 35,
