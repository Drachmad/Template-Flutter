...
Widget KasMasukCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<KasmasukController>(
      builder: (context, kasmasukController, child) {
    var data_so = kasmasukController.data_kasmasuk_list[index];
    String tanggal =
        DateFormat('yyyy-MM-dd').format(DateTime.parse(data_so['TGL']));
    print(tanggal);
    String nobukti = data_so['NO_BUKTI'];
    String ket = data_so['KET'];
    String cash = data_so['BACNO'].toString();
