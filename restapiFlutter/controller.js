    ...
    connection.query("insert into hrd_absend (no_bukti,flag,kd_bag,nm_bag,kd_peg,nm_peg,kd_grup,nm_grup,dr,ptkp,hr,jam1,jam2,jam1rp,jam2rp,lain,tperbulan,jumlah,per) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [no_bukti, flag, kd_bag, nm_bag, kd_peg, nm_peg, kd_grup, nm_grup, dr, ptkp, hr, jam1, jam2, jam1rp, jam2rp, lain, insentifbulanan, jumlah, per],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Tambah harian Detail', res);
            }
        });
};
    ...
    connection.query("UPDATE hrd_absen set kd_bag=?,nm_bag=?,notes=? WHERE no_bukti=?", [kd_bag, nm_bag, notes, no_bukti],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Edit Harian Header', res);
            }
        });
};
    ...
    connection.query("insert into hrd_absend (no_bukti,kd_bag,kd_peg,nm_peg,ptkp,hr,jam1,jam2,jam1rp,jam2rp,lain,tperbulan,jumlah) values (?,?,?,?,?,?,?,?,?,?,?,?,?)", [no_bukti, kd_bag, kd_peg, nm_peg, ptkp, hr, jam1, jam2, jam1rp, jam2rp, lain, insentifbulanan, jumlah],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Tambah Borongan Detail', res);
            }
        });
};
    ...
    connection.query("UPDATE hrd_absen set kd_bag=?,nm_bag=?,notes=? WHERE no_bukti=?", [kd_bag, nm_bag, notes, no_bukti],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Edit Borongan Header', res);
            }
        });
};
    ...
    connection.query("insert into hrd_kikd (no_bukti,kd_bag,kd_peg,nm_peg,ptkp,hr,jam1,jam2,jam1rp,jam2rp,lain,tperbulan,jumlah) values (?,?,?,?,?,?,?,?,?,?,?,?,?)", [no_bukti, kd_bag, kd_peg, nm_peg, ptkp, hr, jam1, jam2, jam1rp, jam2rp, lain, insentifbulanan, jumlah],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Tambah KIK jahit Detail', res);
            }
        });
};
    ...
    connection.query("UPDATE hrd_kik set kd_bag=?,nm_bag=?,notes=? WHERE no_bukti=?", [kd_bag, nm_bag, notes, no_bukti],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Edit KIK Jahit Header', res);
            }
        });
};
    ...
    connection.query("delete from ?? where NO_BUKTI = ?", [tabel, NO_BUKTI],
        function (error, rows, fields) {
            if (error) {
                ...
                response.ok('Berhasil Tambah KIK Jahit Header', res);
...
///HEADER
exports.kasmasuk_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    var offset_page = Number(req.body.offset);
    var limit_page = Number(req.body.limit);
    connection.query("select * from kas where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BKM' LIMIT ?, ?", [filter_cari, filter_cari, tgl_awal, tgl_akhir, offset_page, limit_page], function (error, rows, fields) {
        if (error) {
            console.log(error);
        } else {
...
///paginate Kas Masuk
exports.count_kasmasuk_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    connection.query("select COUNT(*) from kas where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BKM'", [filter_cari, filter_cari, tgl_awal, tgl_akhir],
        function (error, rows, fields) {
            if (error) {
                console.log(error);
            } else {
...
exports.kaskeluar_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    var offset_page = Number(req.body.offset);
    var limit_page = Number(req.body.limit);
    connection.query("select * from kas where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BKK' LIMIT ?, ?", [filter_cari, filter_cari, tgl_awal, tgl_akhir, offset_page, limit_page], function (error, rows, fields) {
        if (error) {
            console.log(error);
        } else {
...
///paginate Kas Masuk
exports.count_kaskeluar_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    connection.query("select COUNT(*) from kas where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BKK'", [filter_cari, filter_cari, tgl_awal, tgl_akhir],
        function (error, rows, fields) {
            if (error) {
                console.log(error);
            } else {
...
///HEADER
exports.bankmasuk_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    var offset_page = Number(req.body.offset);
    var limit_page = Number(req.body.limit);
    connection.query("select * from bank where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BBM' LIMIT ?, ?", [filter_cari, filter_cari, tgl_awal, tgl_akhir, offset_page, limit_page], function (error, rows, fields) {
        if (error) {
            console.log(error);
        } else {
...
///paginate Kas Masuk
exports.count_bankmasuk_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    connection.query("select COUNT(*) from bank where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BBM'", [filter_cari, filter_cari, tgl_awal, tgl_akhir],
        function (error, rows, fields) {
            if (error) {
                console.log(error);
            } else {
...
exports.bankkeluar_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    var offset_page = Number(req.body.offset);
    var limit_page = Number(req.body.limit);
    connection.query("select * from bank where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BBK' LIMIT ?, ?", [filter_cari, filter_cari, tgl_awal, tgl_akhir, offset_page, limit_page], function (error, rows, fields) {
        if (error) {
            console.log(error);
        } else {
...
exports.count_bankkeluar_paginate = function (req, res) {
    ...
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    connection.query("select COUNT(*) from bank where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND TYPE='BBK'", [filter_cari, filter_cari, tgl_awal, tgl_akhir],
        function (error, rows, fields) {
            if (error) {
                console.log(error);
            } else {
...
exports.memo_paginate = function (req, res) {
    ...
    var offset_page = Number(req.body.offset);
    var limit_page = Number(req.body.limit);
    connection.query("select * from memo where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND FLAG='BL' LIMIT ?, ?", [filter_cari, filter_cari, tgl_awal, tgl_akhir, offset_page, limit_page], function (error, rows, fields) {
        if (error) {
            console.log(error);
        } else {
...
///paginate Kas Masuk
exports.count_memo_paginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
    var tgl_awal = req.body.tglawal;
    var tgl_akhir = req.body.tglakhir;
    connection.query("select COUNT(*) from memo where if(?<>'',NO_BUKTI like ?,true) AND TGL BETWEEN ? AND ? AND FLAG='BL'", [filter_cari, filter_cari, tgl_awal, tgl_akhir],
        function (error, rows, fields) {
            if (error) {
                console.log(error);
            } else {
